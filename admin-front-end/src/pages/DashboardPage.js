                    ...
                    <div className="col-12 stretch-card grid-margin">
                        <div className="card card-secondary">
                            <span className="card-body d-lg-flex align-items-center">
                                <p className="mb-lg-0">Like what you see? Check out our premium version for more.</p>
                                <a href="" target="_blank" className="btn ml-lg-auto download-button btn-success btn-sm my-1 my-sm-0">Success</a>
                                <a href="" target="_blank" className="btn btn-warning purchase-button btn-sm ml-sm-2 my-1 my-sm-0">Info</a>
                                ...
                                <div className="table-responsive border rounded p-1">
                                    <table className="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img className="img-sm rounded-circle" src={process.env.PUBLIC_URL+"/admin/images/faces/face1.jpg"} alt="profile image" /> Katie Holmes </td>
                                                <td>$3621</td>
                                                <td><img src={process.env.PUBLIC_URL+"/admin/images/dashboard/alipay.png"} alt="alipay" className="gateway-icon mr-2" /> alipay</td>
                                                <td>04 Jun 2019</td>
                                                <td>18 Jul 2019</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img className="img-sm rounded-circle" src={process.env.PUBLIC_URL+"/admin/images/faces/face2.jpg"} alt="profile image" /> Minnie Copeland </td>
                                                <td>$6245</td>
                                                <td><img src={process.env.PUBLIC_URL+"/admin/images/dashboard/paypal.png"} alt="alipay" className="gateway-icon mr-2" /> Paypal</td>
                                                <td>25 Sep 2019</td>
                                                <td>07 Oct 2019</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img className="img-sm rounded-circle" src={process.env.PUBLIC_URL+"admin/assets/images/faces/face3.jpg"} alt="profile image" /> Rodney Sims </td>
                                                <td>$9265</td>
                                                <td><img src={process.env.PUBLIC_URL+"/admin/images/dashboard/alipay.png"} alt="alipay" className="gateway-icon mr-2" /> alipay</td>
                                                <td>12 dec 2019</td>
                                                <td>26 Aug 2019</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img className="img-sm rounded-circle" src={process.env.PUBLIC_URL+"/admin/images/faces/face4.jpg"} alt="profile image" /> Carolyn Barker </td>
                                                <td>$2263</td>
                                                <td><img src={process.env.PUBLIC_URL+"/admin/images/dashboard/alipay.png"} alt="alipay" className="gateway-icon mr-2" /> alipay</td>
                                                <td>30 Sep 2019</td>
                                                <td>20 Oct 2019</td>
