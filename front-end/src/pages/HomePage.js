                    ...
                    <div className="row">
                        <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div className="d-lg-flex">
                                ...
                                <a className="btn-watch-video"> Watch Video <i className="icofont-play-alt-2"></i></a>
                            </div>
                        </div>
                        <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                            <img src={process.env.PUBLIC_URL+"/user/img/hero-img.png"} className="img-fluid animated" alt="" />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row" data-aos="zoom-in">
                            ...
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src={process.env.PUBLIC_URL+"/user/img/clients/client-1.png"} className="img-fluid" alt="" />
                            </div>

                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src={process.env.PUBLIC_URL+"/user/img/clients/client-2.png"} className="img-fluid" alt="" />
                            </div>

                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src={process.env.PUBLIC_URL+"/user/img/clients/client-3.png"} className="img-fluid" alt="" />
                            </div>

                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src={process.env.PUBLIC_URL+"/user/img/clients/client-4.png"} className="img-fluid" alt="" />
                            </div>

                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src={process.env.PUBLIC_URL+"/user/img/clients/client-5.png"} className="img-fluid" alt="" />
                            </div>

                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src={process.env.PUBLIC_URL+"/user/img/clients/client-6.png"} className="img-fluid" alt="" />
                            </div>
                    ...
                    <div className="container" data-aos="fade-up">
                        ...
                        <div className="row">
                            <div className="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                                <img src={process.env.PUBLIC_URL+"/user/img/skills.png"} className="img-fluid" alt="" />
                            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div className="portfolio-info">
              ...
              <a href="portfolio-details.html" className="details-link" title="More Details"><i className="bx bx-link"></i></a>
                ...
                <section className="our-blog-section ptb-100 section-bg">
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <div className="single-blog-card card border-0 shadow-sm">
                                    ...
                                    <img src="http://datrics.themetags.com/img/blog/1.jpg" className="card-img-top position-relative" alt="blog" />
                                    <div className="card-body">
                                        ...
                                        <div className="post-meta mb-2">
                                            <ul className="list-inline meta-list">
                                                ...
                                                <li className="list-inline-item"><span>45</span> Comments</li>
                                                <li className="list-inline-item"><span>10</span> Share</li>
                                            </ul>
                                        </div>
                                        <p className="card-text">Some quick example text to build on the card title and make up the bulk.</p>
                                        <a href="#" className="detail-link">Read more <span className="ri-arrow-right-line"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="single-blog-card card border-0 shadow-sm">
                                    ...
                                    <img src="http://datrics.themetags.com/img/blog/2.jpg" className="card-img-top position-relative" alt="blog" />
                                    <div className="card-body">
                                        <h3 className="h5 mb-2 card-title"><a href="#">Quickly formulate backend</a></h3>
                                        <div className="post-meta mb-2">
                                            <ul className="list-inline meta-list">
                                                <li className="list-inline-item">May 26, 2019</li>
                                                <li className="list-inline-item"><span>30</span> Comments</li>
                                                <li className="list-inline-item"><span>5</span> Share</li>
                                            </ul>
                                        </div>
                                        <p className="card-text">Synergistically engage effective ROI after customer directed partnerships.</p>
                                        <a href="#" className="detail-link">Read more <span className="ri-arrow-right-line"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="single-blog-card card border-0 shadow-sm">
                                    ...
                                    <img src="http://datrics.themetags.com/img/blog/3.jpg" className="card-img-top" alt="blog" />
                                    <div className="card-body">
                                        <h3 className="h5 mb-2 card-title"><a href="#">Objectively extend extensive</a></h3>
                                        <div className="post-meta mb-2">
                                            <ul className="list-inline meta-list">
                                                <li className="list-inline-item">Apr 25, 2019</li>
                                                <li className="list-inline-item"><span>41</span> Comments</li>
                                                <li className="list-inline-item"><span>30</span> Share</li>
                                            </ul>
                                        </div>
                                        <p className="card-text">Holisticly mesh open-source leadership rather than proactive users. </p>
                                        <a href="#" className="detail-link">Read more <span className="ri-arrow-right-line"></span></a>
                                    </div>
                                </div>
                            </div>
